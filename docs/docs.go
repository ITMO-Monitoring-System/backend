...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/visits.GetTeacherSubjectsResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/api/visits/teacher/{lecture_id}/groups": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/visits.GetLectureGroupsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request",
        ...
        "/api/visits/teacher/{lecture_id}/{group_code}/students": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/visits.GetLectureGroupStudentsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request",
        ...
        "/api/visits/teacher/{subject_id}/lectures": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/visits.GetTeacherLecturesResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request",
    ...
    "definitions": {
        ...
        "visits.GetLectureGroupStudentsResponse": {
            "type": "object",
            "properties": {
                "group_code": {
                    "type": "string"
                ...
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/visits.StudentOnLectureItem"
                    }
                },
                "lecture_id": {
                    "type": "integer"
        ...
        "visits.GetLectureGroupsResponse": {
            "type": "object",
            "properties": {
                "groups": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/visits.GroupItem"
                    }
                },
                "lecture_id": {
                    "type": "integer"
        ...
        "visits.GetTeacherLecturesResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/visits.TeacherLectureItem"
                    }
                },
                "meta": {
                    "$ref": "#/definitions/visits.PageMeta"
        ...
        "visits.GetTeacherSubjectsResponse": {
            "type": "object",
            "properties": {
                "subjects": {
                    "type": "array",
